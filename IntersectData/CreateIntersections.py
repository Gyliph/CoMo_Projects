...
def setupFiles(roadsFC, newRoadsFC, cityBoundFC):
    ...
    if(arcpy.Exists(env.workspace + "\\" + intersectFC)):
        ...
        arcpy.CopyFeatures_management("Database Connections\\ARCSDE_10.sde\\City.DBO.Transportation\\City.DBO.ROADS", roadsFC)
        ...
        UpdateIntersections.update(roadsFC, cityBoundFC) #If it already exists, reroute to the update script
        return
    #Create Geodatabase
    ...
    IntersectAnalysis.runAnalysis(featLyrIntersect, featLyrRoad, False)
